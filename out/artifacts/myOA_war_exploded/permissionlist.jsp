            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach var="role" items="${allRoles}">
                    <tr id="${role.id}">
                        <td>${role.name}</td>
                        <td>
                            <a href="#" onclick="viewPermissions('${role.id}')" class="btn btn-info btn-xs"
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="permissionForm" action="${ctx}/updateRoleAndPermission" method="post">
...
<script type="text/javascript">
    ...
    function closePanel() {
        window.location.href = "${ctx}/findRoles";
    }

    function deleteRole(id) {
        if (confirm("确定要删除吗?")) {
            window.location.href = "${ctx}/deleteRole?roleId=" + id;
        }
    }
