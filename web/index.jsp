        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="hard-navbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="welcome.html" class="atip" target="appiframe" data-toggle="tooltip" data-placement="bottom"
                           data-title="首页"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
                    <li class="dropdown">
    ...
    <div class="main-wapper">
        ...
        <div id="siderbar" class="siderbar-wapper">
            <div class="panel-group menu" id="accordion" role="tablist" aria-multiselectable="true">
                <c:forEach var="menu" items="${activeUser.menus}" varStatus="state">
                    <div class="panel panel-inner">
                        ...
                        <div id="collapse${state.index}" class="panel-collapse collapse in" role="tabpanel"
                             aria-labelledby="heading${state.index}">
                            <div class="list-group list-group-self">
                                <c:forEach var="subMenu" items="${menu.children}">
                                    <a href="${subMenu.url}" target="appiframe" class="list-group-item"><span
        ...
        <div id="content" class="main-content">
            ...
            <iframe src="welcome.html" style="width:100%;height: 100%;" id="appiframe" name="appiframe"
